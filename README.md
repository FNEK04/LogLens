...
**LogLens** — desktop-приложение для локального анализа больших логов и дампов (сотни MB → десятки GB) без поднятия ELK, ClickHouse или облаков.
